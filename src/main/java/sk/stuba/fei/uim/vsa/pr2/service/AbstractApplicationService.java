 ...
 */
public abstract class AbstractApplicationService<S, T, A> implements AutoCloseable {

    protected static final Logger log = LoggerFactory.getLogger(AbstractApplicationService.class);
     ...
     */
    public abstract S createStudent(Long aisId, String name, String email, String password, Long year, Long term, String programme);
     ...
     */
    public abstract T createTeacher(Long aisId, String name, String email, String password, String department);
     ...
     */
    public abstract A makeThesisAssignment(Long supervisor, String title, String type, String description, String registrationNumber);
